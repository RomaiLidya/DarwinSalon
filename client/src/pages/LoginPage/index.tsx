import { Container, Grid, InputAdornment, IconButton, Paper, TextField, Theme, Divider } from '@material-ui/core';
...
const LoginPage: FC = () => {
  ...
  const login = useCallback(async () => {
    ...
    try {
      const response = await axios.post(LOGIN_URL, { username: email, password }, { cancelToken: cancelTokenSource.token });
